...
<head>
    ...
    <link rel="stylesheet" id="wp-block-library-css" href="{{ asset('template01/css/style.min.css') }}" media="all">
    ...
    <link rel="stylesheet" id="uikit-css" href="{{ asset('template01/css/uikit.min.css') }}" media="all">
    ...
    <link rel="stylesheet" id="swiper slide-css" href="{{ asset('template01/css/swiper-bundle.min.css') }}"
        media="all">
    <link rel="stylesheet" id="animation-css" href="{{ asset('template01/css/animation.css') }}" media="all">
    <link rel="stylesheet" id="aos style-css" href="{{ asset('template01/css/aos.css') }}" media="all">
    <link rel="stylesheet" id="footer style-css" href="{{ asset('template01/css/footer.css') }}" media="all">
    <link rel="stylesheet" id="wedding style-css" href="{{ asset('template01/css/wedding.css') }}" media="all">
    <link rel="stylesheet" id="theme-css" href="{{ asset('template01/css/theme.css') }}" media="all">
...
<body
  ...
  <div class="container">
    ...
    <script src="{{ asset('template01/css/style.css') }}" id="comment-reply-js" async="" data-wp-strategy="async"></script>
