...
<head>
    ...
    <link rel="stylesheet" id="wedding reset-css" href="{{ asset('template07/css/reset-wedding.css') }}"
        media="all">
    <link rel="stylesheet" id="fancybox-css" href="{{ asset('template07/css/fancybox.css') }}" media="all">
    <link rel="stylesheet" id="swiper slide-css" href="{{ asset('template07/css/swiper-bundle.min.css') }}"
        media="all">
...
<body
    class="mau-thiep-template mau-thiep-template-templates mau-thiep-template-cobasg mau-thiep-template-templatescobasg-php single single-mau-thiep postid-1122 no-sidebar">
    ...
    <section id="banner" class="section-banner">
        <img src="{{ asset($weddingCard->banner_top) }}" alt="" class="banner-img kenburns-top banner_top"
        ...
        <div class="banner-container container">
            <div class="banner-content uk-text-center">
                ...
                <div class="banner-date">
                    <span
                        class="text-white">{{ \Carbon\Carbon::parse($weddingCard->wedding_date)->day }}.{{ \Carbon\Carbon::parse($weddingCard->wedding_date)->month }}.{{ \Carbon\Carbon::parse($weddingCard->wedding_date)->year }}</span>
                </div>
        ...
        <div class="about-container container">
            ...
            <div class="about-card" style="order:1">
                <div class="about-media" data-aos="fade-left" data-aos-duration="3000">
                    <img src="{{ asset($weddingCard->groom_avatar) }}" alt="" class="bride_img">
                </div>
                <div class="about-data uk-text-right" data-aos="fade-right" data-aos-duration="3000"
                    style="color: #5b5b5b">

                    <h3 class="bride_name">{{ $weddingCard->groom_name }}</h3>
                    <p class="bride_des">{{ $weddingCard->des_groom }}</p>
                    <hr>
                </div>
    ...
    {{-- <section id="message" class="section-message uk-background-cover uk-section"
        style="background-image:url({{ asset('template07/images/2A2DA651-F8B2-49DE-BEC2-827474A74581-e1705076862988.jpeg') }}); display:block">
  ...
  return false;
    ...
    <section id="thankyou" class="section-thankyou bg_overlay uk-position-z-index">
        ...
        <div class="thankyou-body container uk-position-relative uk-position-z-index">
            ...
            <p class="thankyou-des main-font" data-aos="fade-down" data-aos-duration="2000">{{ $weddingCard->message_thanks }}</p>
            <p></p>
