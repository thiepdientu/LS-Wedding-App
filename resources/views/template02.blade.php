...
<head>
    ...
    <link rel="stylesheet" id="wp-block-library-css" href="{{ asset('template02/css/style.min.css') }}" media="all">
    ...
    <link rel="stylesheet" id="uikit-css" href="{{ asset('template02/css/uikit.min.css') }}" media="all">
    <link rel="stylesheet" id="reset uikit-css" href="{{ asset('template02/css/reset1.css') }}" media="all">
    <link rel="stylesheet" id="remixicon-css" href="{{ asset('template02/css/remixicon.css') }}" media="all">
    <link rel="stylesheet" id="preload-css" href="{{ asset('template02/css/preload.css') }}" media="all">
    <link rel="stylesheet" id="wedding reset-css" href="{{ asset('template02/css/reset-wedding.css') }}"
        media="all">
    <link rel="stylesheet" id="fancybox-css" href="{{ asset('template02/css/fancybox.css') }}" media="all">
    <link rel="stylesheet" id="swiper slide-css" href="{{ asset('template02/css/swiper-bundle.min.css') }}"
        media="all">
    <link rel="stylesheet" id="animation-css" href="{{ asset('template02/css/animation.css') }}" media="all">
    <link rel="stylesheet" id="aos style-css" href="{{ asset('template02/css/aos.css') }}" media="all">
    <link rel="stylesheet" id="footer style-css" href="{{ asset('template02/css/footer.css') }}" media="all">
    <link rel="stylesheet" id="wedding style-css" href="{{ asset('template02/css/wedding.css') }}" media="all">
    <link rel="stylesheet" id="theme-css" href="{{ asset('template02/css/theme.css') }}" media="all">
    <script src="{{ asset('template02/js/jquery.min_1.js') }}" id="jquery-core-js"></script>
    <script src="{{ asset('template02/js/jquery-migrate.min.js') }}" id="jquery-migrate-js"></script>
    <script src="{{ asset('template02/js/jquery.min.js') }}" id="Jquery-js"></script>
...
<body
    class="mau-thiep-template mau-thiep-template-templates mau-thiep-template-hiendai mau-thiep-template-templateshiendai-php single single-mau-thiep postid-1045 no-sidebar">
    ...
    <section id="banner" class="section-banner uk-position-z-index">
        <img src="{{ asset($weddingCard->banner_top) }}" alt="" class="banner-bg"
            style="object-position:center center; ">
        <span class="overlay"></span>
        <div class="container banner">
            <h1 style="margin-top: 200px;font-size: 20px;" class="banner-title" data-aos="fade-down"
  ...
  <div class="container">
    <form action="" method="post" id="form-wedding" style="background-image:url(images/paper-cut-sweet-pink-envelope-and-heart-with-copy-space-for-design-valentine-s-day-or-love-day-background-concept-send-a-letter-to-a-lover-couple-free-vector.jpg)">
      ...
      <div class="form-container">
          ...
          <label class="radio-container">TƯ GIA NHÀ TRAI            <span class="tooltip"> <p>ẤP HAI;, XÃ TÂN BÌNH, HUYỆN THANH BÌNH, TỈNH ĐỒNG THÁP</p>
 </span>
    ...
    <script src="{{ asset('template02/js/fancybox.umd.js') }}" id="fancybox js-js"></script>
    <script src="{{ asset('template02/js/uikit.min.js') }}" id="uikit js-js"></script>
    <script src="{{ asset('template02/js/uikit-icons.min.js') }}" id="uikit icon-js"></script>
    <script src="{{ asset('template02/js/preloader.js') }}" id="preloader js-js"></script>
    <script src="{{ asset('template02/js/aos.js') }}" id="aos js-js"></script>
    <script src="{{ asset('template02/js/swiper-bundle.min.js') }}" id="swiper slide-js"></script>
    <script src="{{ asset('template02/js/scrollreveal.min.js') }}" id="scrollrevea-js"></script>
    <script src="{{ asset('template02/js/main-wedding.js') }}" id="main wedding-js"></script>
    <script src="{{ asset('template02/js/comment-reply.min.js') }}" id="comment-reply-js" async=""
