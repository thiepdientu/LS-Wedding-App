...
<link rel="stylesheet" id="wp-block-library-css" href="{{ asset('template03/css/style.min.css') }}" media="all">
...
<link rel="stylesheet" id="uikit-css" href="{{ asset('template03/css/uikit.min.css') }}" media="all">
<link rel="stylesheet" id="reset uikit-css" href="{{ asset('template03/css/reset1.css') }}" media="all">
<link rel="stylesheet" id="remixicon-css" href="{{ asset('template03/css/remixicon.css') }}" media="all">
<link rel="stylesheet" id="preload-css" href="{{ asset('template03/css/preload.css') }}" media="all">
<link rel="stylesheet" id="wedding reset-css" href="{{ asset('template03/css/reset-wedding.css') }}" media="all">
<link rel="stylesheet" id="fancybox-css" href="{{ asset('template03/css/fancybox.css') }}" media="all">
<link rel="stylesheet" id="swiper slide-css" href="{{ asset('template03/css/swiper-bundle.min.css') }}" media="all">
<link rel="stylesheet" id="animation-css" href="{{ asset('template03/css/animation.css') }}" media="all">
<link rel="stylesheet" id="aos style-css" href="{{ asset('template03/css/aos.css') }}" media="all">
<link rel="stylesheet" id="footer style-css" href="{{ asset('template03/css/footer.css') }}" media="all">
<link rel="stylesheet" id="wedding style-css" href="{{ asset('template03/css/wedding.css') }}" media="all">
<link rel="stylesheet" id="theme-css" href="{{ asset('template03/css/theme.css') }}" media="all">
<script src="{{ asset('template03/js/jquery.min_1.js') }}" id="jquery-core-js"></script>
<script src="{{ asset('template03/js/jquery-migrate.min.js') }}" id="jquery-migrate-js"></script>
<script src="{{ asset('template03/js/jquery.min.js') }}" id="Jquery-js"></script>
...
<meta name="msapplication-TileImage" content="https://thiepdientu.s3.ap-southeast-1.amazonaws.com/wp-content/uploads/2024/03/26115441/cropped-logo-favicon-270x270.png">
    <link rel="stylesheet" href="{{ asset('template03/css/style.css') }}">
<script src="{{ asset('template03/js/wp-emoji-release.min.js') }}" defer=""></script></head>
...
<!-- END PRELOAD -->   <!-- HEADER -->
   <header>
    <section id="banner" class="banner">
     <img src="{{ asset($weddingCard->banner_top) }}" alt="" class="banner_top kenburns-top" data-aos="fade" data-aos-duration="3000" style="object-position:center center">
     <div class="container">
      <div class="banner-container">
        <h2 class="banner-title script-font" data-aos="fade-down" data-aos-duration="3000"><p>Save The Date</p>
</h2>	
<p class="uk-text-center">{{ $weddingCard->message_invite }} </p>
        <p class="banner-slogan script-font" data-aos="fade-up" data-aos-duration="3000"></p>
        <div class="banner-name">
        	<p>{{ $weddingCard->groom_name }} 
<span>&amp;</span> 
{{ $weddingCard->bride_name }}  </p>
        ...
        {{ $weddingDay }}</span>
         ...
         <center>
  			<p><p style="margin: 0px;text-align:center" class="">{{ $weddingCard->time_groom_al }}</p></p>
		</center>
        <div class="banner-location" data-aos="fade-up" data-aos-duration="3000">
          <p class="script-font">{{ $weddingCard->wedding_message }} </p>
          <p class="banner_sub_location" style="font-weight: bold;">{{ $weddingCard->name_place_wedding }}</p>
          <p class="banner_sub_location">{{ $weddingCard->address_wedding }}</p>
 			{{-- <p class="banner_sub_location">( đón khách 18:30 - vào tiệc 19:30 )</p> --}}
         <!--  <p class="banner_location_adress">Số 668 - Đường Phan Đình Phùng - Phường Đồng Quang - Thành phố Thái Nguyên</p> -->
        </div>
<!--  <div class="banner-location" data-aos="fade-up" data-aos-duration="3000">
          <p>2. Ngày 02/12 (tức ngày 02 tháng 11 năm giáp thìn) vào lúc 17:30 </p>
          <p class="banner_sub_location">Tại Trung tâm tiệc cưới khách sạn Cầu Am, tầng 3
Số 09, Chu Văn An, Yết Kiêu, Hà Đông, Hà Nội ( đón khách 16:30 - vào tiệc 17:30)</p>
        ...
        <div class="about-container">
          <div class="about-card" style="order:1">
            ...
            <div class="about-body" data-aos="fade-up" data-aos-duration="3000">
              ...
              <!-- <p class="bride_birthday">27/07/2000</p>
              <p class="bride_birthday">TP. Thái Nguyên</p> -->
             <!--  <p class="bride_des">Cô dâu thuộc tuýp người hướng nội, dịu dàng, điệu đà, sở thích làm đẹp và nghệ thuật, đi du lịch.</p> -->
                          </div>
          </div>
          <div class="about-card" style="order:1">
            <div class="about-media">
            ...
            <div class="about-body" data-aos="fade-up" data-aos-duration="3000">
             ...
             <!-- <p class="groom_birthday">19/12/1994</p>
              <p class="groom_birthday">Hà Nội</p> -->
              <!-- <p class="groom_des">Chú rể thuộc tuýp người hướng ngoại, thân thiện, cởi mở, nhiệt tình, sở thích thể thao và du lịch khám phá</p> -->
                          </div>
          </div>
        </div>
...
<div class="count-down section-countdown img_bg bg_overlay" style="background-image:url({{ asset($weddingCard->banner_coundown) }})">
  ...
  <!--           <div class="invitation-container">
                        <div class="invitation-card"> <img src="images/z5060767695932_9485b9ebd68d6bbfe96c74a9e646a36e.jpg" alt=""> 
                ...
                <address class="uk-margin-remove">
                    ...
                    <p class="invi_amlich">Nhằm ng�&nbsp;y 18 tháng 11 Năm Qúy Mão</p> 
                </div> 
                    ...
                    <div class="invitation-card"> <img src="images/z5060767681645_908f51b2fc064c883858b516804ba6df.jpg" alt=""> 
                <h3 class="card-title uk-margin-remove">Tư GIA NHÀ GÁI</h3>
                <address class="uk-margin-remove">
                    <p>ẤP H�&nbsp;, XÃ TÂN BÌNH, HUYỆN THANH BÌNH, TỈNH ĐỒNG THÁP</p>
                </address> 
                				                <div class="invitation-body"> <div class="invi_time">
                    <p class="fw-bold">V�&nbsp;o lúc 
                        <span class="invi_hours">
                    ...
                    <p class="invi_amlich">Nhằm ng�&nbsp;y 17 tháng 12 năm Quý Mão</p> 
                </div> 
...
<!-- <section id="time-line" class="time-line-section img_bg bg_overlay" style="background-image:url(images/z5060767670936_747591aba63c4e458a7c940ae3ab6efc.jpg)">
...
<div class="timeline-list">
    ...
    <div class="timeline-media"> 
        ...
        <img src="images/z5060767676916_229bfbefee321ada1dd748e98811c4d5.jpg" alt="" class="timline-img"> 
    ...
    <div class="timeline-body"> 
        ...
        <p class="timeline-des uk-margin-remove"></p><p>Ng�&nbsp;y ấy vu vơ đăng một dòng status trên facebook than thở, vu vơ đùa giỡn nói chuyện với một người xa lạ chưa từng quen.</p>
<p></p> 
    ...
    <div class="timeline-media"> 
        ...
        <img src="images/z5060767681645_908f51b2fc064c883858b516804ba6df.jpg" alt="" class="timline-img"> 
...
<p></p> 
    ...
    <div class="timeline-media"> 
        ...
        <img src="images/z5060767687836_b8a32fe55486b0e4d0dbea186edda36d.jpg" alt="" class="timline-img"> 
...
<p></p> 
    ...
    <div class="timeline-media"> 
        ...
        <img src="images/z5060767695932_9485b9ebd68d6bbfe96c74a9e646a36e.jpg" alt="" class="timline-img"> 
    ...
    <div class="timeline-body"> 
        ...
        <span class="title">Lễ Th�&nbsp;nh Hôn</span> 
...
<!-- LỜI CHÚC -->
<!-- TIN NHẮN -->
<!-- <section id="message" class="section-message uk-background-cover uk-section" style="background-image:url(images/z5060767692779_8a1f96910453bfc84bd0f40298ead7ff.jpg); display:block">
...
<!-- GỬI QUÀ -->
 <section id="gift" class="section-gift" style="display:block">
      <div class="container">
        <p class="subtitle"></p>
        <h2 class="uk-heading-small uk-text-center script-font  uk-text-cappercase">Gửi Quà Đến Cô Dâu & Chú Rể</h2>
...
<section id="thankyou" class="section-thankyou bg_overlay uk-position-z-index">
	<div class="uk-overlay uk-overlay-primary uk-position-cover"> </div>
      ...
      <div class="thankyou-body container uk-position-relative uk-position-z-index">
        ...
        <p class="thankyou-des" data-aos="fade" data-aos-duration="3000"></p><p>{{ $weddingCard->message_thanks }}</p>
<p></p>
...
<!-- AUDIO -->
<audio src="{{ asset('template01/media/Shane-Filan-Beautiful-In-White-Official-Video.mp3') }}" controls="" autoplay="" id="audio">

</audio>
<!-- END AUDIO --> <!-- FOOTER -->
 <footer>
        <div class="footer-bottom">
            <p>Copyrighter 2025 thuộc về   <a class="uk-text-bold" href="https://www.facebook.com/profile.php?id=61564156101208" class="facebook">
               LS Wedding
            </a></p>
        </div>
</footer>
<button class="toggleAudio">
    ...
    <script src="{{ asset('template03/js/fancybox.umd.js') }}" id="fancybox js-js"></script>
<script src="{{ asset('template03/js/uikit.min.js') }}" id="uikit js-js"></script>
<script src="{{ asset('template03/js/uikit-icons.min.js') }}" id="uikit icon-js"></script>
<script src="{{ asset('template03/js/preloader.js') }}" id="preloader js-js"></script>
<script src="{{ asset('template03/js/aos.js') }}" id="aos js-js"></script>
<script src="{{ asset('template03/js/swiper-bundle.min.js') }}" id="swiper slide-js"></script>
<script src="{{ asset('template03/js/scrollreveal.min.js') }}" id="scrollrevea-js"></script>
<script src="{{ asset('template03/js/main-wedding.js') }}" id="main wedding-js"></script>
<script src="{{ asset('template03/js/comment-reply.min.js') }}" id="comment-reply-js" async="" data-wp-strategy="async"></script>
