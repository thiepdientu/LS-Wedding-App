...
<head>
    ...
    <link rel="stylesheet" id="wedding reset-css" href="{{ asset('template03/css/reset-wedding.css') }}"
        media="all">
    <link rel="stylesheet" id="fancybox-css" href="{{ asset('template03/css/fancybox.css') }}" media="all">
    <link rel="stylesheet" id="swiper slide-css" href="{{ asset('template03/css/swiper-bundle.min.css') }}"
        media="all">
    ...
    <script src="{{ asset('template03/js/wp-emoji-release.min.js') }}" defer=""></script>
</head>

<body
    class="mau-thiep-template mau-thiep-template-templates mau-thiep-template-sangtrong mau-thiep-template-templatessangtrong-php single single-mau-thiep postid-999 no-sidebar">
        ...
        <section id="banner" class="banner">
            ...
            <div class="container">
                <div class="banner-container">
                    <h2 class="banner-title script-font" data-aos="fade-down" data-aos-duration="3000">
                        <p>Save The Date</p>
                    </h2>
                    ...
                    <div class="banner-date">
                        ...
                        <span class="banner_month" data-aos="fade-left"
                            data-aos-duration="3000">{{ \Carbon\Carbon::parse($weddingCard->wedding_date)->month }}</span>

                    </div>
                    <center>
                        <p>
                        <p style="margin: 0px;text-align:center" class="">{{ $weddingCard->time_groom_al }}</p>
                        </p>
                    </center>
                    <div class="banner-location" data-aos="fade-up" data-aos-duration="3000">
                        <p class="script-font">{{ $weddingCard->wedding_message }} </p>
                        <p class="banner_sub_location" style="font-weight: bold;">
 ...
 <div class="uk-position-cover uk-overlay uk-overlay-primary" style="opacity:.5"> </div>
  ...
  <div class="container">
    ...
    <section id="gift" class="section-gift" style="display:block">
        <div class="container">
            <p class="subtitle"></p>
            <h2 class="uk-heading-small uk-text-center script-font  uk-text-cappercase">Gửi Quà Đến Cô Dâu & Chú Rể
            </h2>
    ...
    <script src="{{ asset('template03/js/comment-reply.min.js') }}" id="comment-reply-js" async=""
