...
{{ $weddingCard->bride_name }}      </div>
            <div class="time">
        <span class="banner_time">Vào Lúc {{ $weddingCard->wedding_time }}</span>
        <br>
        <span class="banner_date">{{\Carbon\Carbon::parse($weddingCard->wedding_date)->day}}.{{\Carbon\Carbon::parse($weddingCard->wedding_date)->month}}.{{\Carbon\Carbon::parse($weddingCard->wedding_date)->year}}</span>
       
      </div>
      <div class="banner-location">
        <p class="main_font">{{ $weddingCard->wedding_message }}</p>
        <p class="location-name" style="font-weight:bold;">{{ $weddingCard->name_place_wedding }}</p>
        <address>{{ $weddingCard->address_wedding }}</address>
      </div>

      <div class="group-button">
        <a href="{{ $weddingCard->address_wedding_map }}" target="_blank" class="btn btn-pri">
 ...
 <section id="about" class="about-section">
    ...
    <div class="container about">
      <div class="about-card" data-aos="fade-up" data-aos-duration="3000" style="order:1">
        <div class="media">
          <img src="{{ asset($weddingCard->groom_avatar) }}" alt="" class="groom-img groom_img">
         
        </div>
        <div class="body">
          <h2 class="groom_name uk-margin-remove">{{ $weddingCard->groom_name }}</h2>
          <p class="groom_birthday uk-margin-remove">{{ $weddingCard->des_groom }}</p>
      ...
      <div class="about-card" data-aos="fade-up" data-aos-duration="3000" style="order:1">
        <div class="media">
          <img src="{{ asset($weddingCard->bride_avatar) }}" alt="" class="groom-img groom_img">
      
        </div>
        <div class="body">
          <h2 class="groom_name uk-margin-remove">{{ $weddingCard->bride_name }}</h2>
          <p class="groom_birthday uk-margin-remove"> {{ $weddingCard->des_bride }}</p>
...
@if (!empty($stories))
<section id="time-line" class="time-line-section img_bg bg_overlay" style="background-image:url({{ asset($weddingCard->banner_love_story) }})">
...
<section id="countdown-secton" class="uk-background-cover uk-section uk-section-large uk-text-center uk-light" style="background-image:url({{ asset($weddingCard->banner_coundown) }})">
...
<section id="gift" class="section-gift" style="display:block">
  <div class="container">
    <p class="subtitle"></p>
    <h2 class="uk-heading-small uk-text-center script-font" style="font-family: var(--script-font);">{{ $weddingCard->message_gift }}</h2>
...
<section id="thankyou" class="section-thankyou bg_overlay uk-position-z-index">
	<div class="uk-overlay uk-overlay-primary uk-position-cover"> </div>
      ...
      <div class="thankyou-body container uk-position-relative uk-position-z-index">
        <h2 class="script-font uk-heading-medium uk-text-center text-white script-font" data-aos="fade-up" data-aos-duration="2000">Thank you!</h2>
