<!DOCTYPE html><html lang="vi" prefix="og: https://ogp.me/ns#"><head>
	...
	<link rel="profile" href="https://gmpg.org/xfn/11">
		<meta property="og:image" content="{{ asset('template06/images/232AA7D4-6D47-4C22-A97B-5BFD8613C2A6-e1705077838673-728x1024.jpeg') }}">
		
<!-- Search Engine Optimization by Rank Math - https://rankmath.com/ -->
<title>Mẫu Thiệp Xanh Lá - Thiệp cưới online</title>
<meta name="robots" content="index, follow, max-snippet:-1, max-video-preview:-1, max-image-preview:large">
<link rel="canonical" href="https://thiepdientu.com.vn/mau-thiep/1138/">
<meta property="og:locale" content="vi_VN">
<meta property="og:type" content="article">
<meta property="og:title" content="Mẫu Thiệp Xanh Lá - Thiệp cưới online">
<meta property="og:url" content="https://thiepdientu.com.vn/mau-thiep/1138/">
<meta property="og:site_name" content="Thiệp cưới online">
<meta property="og:updated_time" content="2024-04-03T04:59:39+00:00">
<meta property="og:image" content="{{ asset('template06/images/232AA7D4-6D47-4C22-A97B-5BFD8613C2A6-e1705077838673.jpeg') }}">
<meta property="og:image:secure_url" content="{{ asset('template06/images/232AA7D4-6D47-4C22-A97B-5BFD8613C2A6-e1705077838673.jpeg') }}">
<meta property="og:image:width" content="960">
<meta property="og:image:height" content="1351">
<meta property="og:image:alt" content="Mẫu Thiệp Xanh Lá">
<meta property="og:image:type" content="image/jpeg">
<meta name="twitter:card" content="summary_large_image">
<meta name="twitter:title" content="Mẫu Thiệp Xanh Lá - Thiệp cưới online">
<meta name="twitter:image" content="https://thiepdientu.com.vn/wp-content/uploads/2024/01/232AA7D4-6D47-4C22-A97B-5BFD8613C2A6-e1705077838673.jpeg') }}">
...
<link rel="alternate" type="application/rss+xml" title="Thiệp cưới online » Mẫu Thiệp Xanh Lá Dòng bình luận" href="https://thiepdientu.com.vn/mau-thiep/1138/feed/">
<script>
...
<link rel="stylesheet" id="wp-block-library-css" href="{{ asset('template06/css/style.min.css') }}" media="all">
...
<link rel="stylesheet" id="uikit-css" href="{{ asset('template06/css/uikit.min.css') }}" media="all">
<link rel="stylesheet" id="reset uikit-css" href="{{ asset('template06/css/reset1.css') }}" media="all">
<link rel="stylesheet" id="remixicon-css" href="{{ asset('template06/css/remixicon.css') }}" media="all">
<link rel="stylesheet" id="preload-css" href="{{ asset('template06/css/preload.css') }}" media="all">
<link rel="stylesheet" id="wedding reset-css" href="{{ asset('template06/css/reset-wedding.css') }}" media="all">
<link rel="stylesheet" id="fancybox-css" href="{{ asset('template06/css/fancybox.css') }}" media="all">
<link rel="stylesheet" id="swiper slide-css" href="{{ asset('template06/css/swiper-bundle.min.css') }}" media="all">
<link rel="stylesheet" id="animation-css" href="{{ asset('template06/css/animation.css') }}" media="all">
<link rel="stylesheet" id="aos style-css" href="{{ asset('template06/css/aos.css') }}" media="all">
<link rel="stylesheet" id="footer style-css" href="{{ asset('template06/css/footer.css') }}" media="all">
<link rel="stylesheet" id="wedding style-css" href="{{ asset('template06/css/wedding.css') }}" media="all">
<link rel="stylesheet" id="theme-css" href="{{ asset('template06/css/theme.css') }}" media="all">
<script src="{{ asset('template06/js/jquery.min_1.js') }}" id="jquery-core-js"></script>
<script src="{{ asset('template06/js/jquery-migrate.min.js') }}" id="jquery-migrate-js"></script>
<script src="{{ asset('template06/js/jquery.min.js') }}" id="Jquery-js"></script>
<link rel="https://api.w.org/" href="https://thiepdientu.com.vn/wp-json/"><link rel="alternate" title="JSON" type="application/json" href="https://thiepdientu.com.vn/wp-json/wp/v2/mau-thiep/1138"><link rel="EditURI" type="application/rsd+xml" title="RSD" href="https://thiepdientu.com.vn/xmlrpc.php?rsd">
<meta name="generator" content="WordPress 6.6.1">
<link rel="shortlink" href="https://thiepdientu.com.vn/?p=1138">
<link rel="alternate" title="oNhúng (JSON)" type="application/json+oembed" href="https://thiepdientu.com.vn/wp-json/oembed/1.0/embed?url=https%3A%2F%2Fthiepdientu.com.vn%2Fmau-thiep%2F1138%2F">
<link rel="alternate" title="oNhúng (XML)" type="text/xml+oembed" href="https://thiepdientu.com.vn/wp-json/oembed/1.0/embed?url=https%3A%2F%2Fthiepdientu.com.vn%2Fmau-thiep%2F1138%2F&amp;format=xml">
		<style type="text/css">
					.site-title,
			.site-description {
				position: absolute;
...
<link rel="apple-touch-icon" href="{{ asset('template06/images/cropped-logo-favicon-180x180.png') }}">
<meta name="msapplication-TileImage" content="https://thiepdientu.s3.ap-southeast-1.amazonaws.com/wp-content/uploads/2024/03/26115441/cropped-logo-favicon-270x270.png') }}">
    <link rel="stylesheet" href="{{ asset('template06/css/style.css') }}">
<script src="{{ asset('template06/js/wp-emoji-release.min.js') }}" defer=""></script></head>
<body class="mau-thiep-template mau-thiep-template-templates mau-thiep-template-xanhla mau-thiep-template-templatesxanhla-php single single-mau-thiep postid-1138 no-sidebar">
...
Phương Ánh    </div>
    ...
    <div class="banner-address uk-position-relative uk-position-z-index">
      ...
      <p class="address-name">Luxury Palace</p>
...
<section id="time-line" class="time-line-section img_bg bg_overlay" style="background-image:url({{ asset('template06/images/C71AB1C4-E24C-456F-A22C-9EA50D0CBD4B-e1705077871513.jpeg') }})">
...
<div class="timeline-list">
    ...
    <div class="timeline-media"> 
        ...
        <img src="{{ asset('template06/images/97A3C4E2-5C2E-4EDE-A68D-9E8C17AC0E8D-e1705078206926.jpeg') }}" alt="" class="timline-img"> 
...
<p></p> 
    ...
    <div class="timeline-media"> 
        ...
        <img src="{{ asset('template06/images/27353812-11C2-4816-BC4F-FD6B025EBDD3-e1705078223213.jpeg') }}" alt="" class="timline-img"> 
...
<p></p> 
    ...
    <div class="timeline-media"> 
        ...
        <img src="{{ asset('template06/images/25607D30-089A-41E0-8D7A-42616F8FDAC0-e1705077734385.jpeg') }}" alt="" class="timline-img"> 
    ...
    <div class="timeline-body"> 
        ...
        <p class="timeline-des uk-margin-remove"></p><p>Chúng ta từ 2 con người xa lạ một bước va vào cuộc đời nhau. Và giờ đây chúng ta tiếp tục cùng nhau sang trang mới.</p>
<p></p> 
    ...
    <div class="timeline-media"> 
        ...
        <img src="{{ asset('template06/images/C08AA1C8-4E82-4D0A-9DB9-4BA0A8C5BDFB-e1705078263569.jpeg') }}" alt="" class="timline-img"> 
    ...
    <div class="timeline-body"> 
        ...
        <p class="timeline-des uk-margin-remove"></p><p> anh không chỉ là người yêu mà chúng ta còn là tri kỷ. Ngày hôm nay, em sẽ là cô dâu của anh</p>
<p></p> 
...
<section id="album" class="uk-section" data-aos="fade-up" data-aos-duration="3000">
    ...
    <div class="album container">
            ...
            <a data-fancybox="gallery" href="https://thiepdientu.com.vn/wp-content/uploads/2024/01/25607D30-089A-41E0-8D7A-42616F8FDAC0-e1705077734385.jpeg') }}">
                <img src="{{ asset('template06/images/25607D30-089A-41E0-8D7A-42616F8FDAC0-e1705077734385.jpeg') }}" alt="">
            </a>
        </div>
                <div class="album-item">
            <a data-fancybox="gallery" href="https://thiepdientu.com.vn/wp-content/uploads/2024/01/7C1BAA19-C248-4E3A-922B-F1A23538EB6A-e1705077793236.jpeg') }}">
                <img src="{{ asset('template06/images/7C1BAA19-C248-4E3A-922B-F1A23538EB6A-e1705077793236.jpeg') }}" alt="">
            </a>
        </div>
                <div class="album-item">
            <a data-fancybox="gallery" href="https://thiepdientu.com.vn/wp-content/uploads/2024/01/27353812-11C2-4816-BC4F-FD6B025EBDD3-e1705078223213.jpeg') }}">
                <img src="{{ asset('template06/images/27353812-11C2-4816-BC4F-FD6B025EBDD3-e1705078223213.jpeg') }}" alt="">
            </a>
        </div>
                <div class="album-item">
            <a data-fancybox="gallery" href="https://thiepdientu.com.vn/wp-content/uploads/2024/01/C71AB1C4-E24C-456F-A22C-9EA50D0CBD4B-e1705077871513.jpeg') }}">
                <img src="{{ asset('template06/images/C71AB1C4-E24C-456F-A22C-9EA50D0CBD4B-e1705077871513.jpeg') }}" alt="">
            </a>
        </div>
                <div class="album-item">
            <a data-fancybox="gallery" href="https://thiepdientu.com.vn/wp-content/uploads/2024/01/97A3C4E2-5C2E-4EDE-A68D-9E8C17AC0E8D-e1705078206926.jpeg') }}">
                <img src="{{ asset('template06/images/97A3C4E2-5C2E-4EDE-A68D-9E8C17AC0E8D-e1705078206926.jpeg') }}" alt="">
            </a>
        </div>
                <div class="album-item">
            <a data-fancybox="gallery" href="https://thiepdientu.com.vn/wp-content/uploads/2024/01/232AA7D4-6D47-4C22-A97B-5BFD8613C2A6-e1705077838673.jpeg') }}">
                <img src="{{ asset('template06/images/232AA7D4-6D47-4C22-A97B-5BFD8613C2A6-e1705077838673.jpeg') }}" alt="">
            </a>
        </div>
                <div class="album-item">
            <a data-fancybox="gallery" href="https://thiepdientu.com.vn/wp-content/uploads/2024/01/964ACDE5-6FC7-4033-B792-E302E11655F7.jpeg') }}">
                <img src="{{ asset('template06/images/964ACDE5-6FC7-4033-B792-E302E11655F7.jpeg') }}" alt="">
            </a>
        </div>
                <div class="album-item">
            <a data-fancybox="gallery" href="https://thiepdientu.com.vn/wp-content/uploads/2024/01/C08AA1C8-4E82-4D0A-9DB9-4BA0A8C5BDFB-e1705078263569.jpeg') }}">
                <img src="{{ asset('template06/images/C08AA1C8-4E82-4D0A-9DB9-4BA0A8C5BDFB-e1705078263569.jpeg') }}" alt="">
            </a>
        </div>
                <div class="album-item">
            <a data-fancybox="gallery" href="https://thiepdientu.com.vn/wp-content/uploads/2024/01/9E2D097B-4E2F-4FF2-9F6F-3D1BEC1955B6-e1705078033877.jpeg') }}">
                <img src="{{ asset('template06/images/9E2D097B-4E2F-4FF2-9F6F-3D1BEC1955B6-e1705078033877.jpeg') }}" alt="">
            </a>
        </div>
                <div class="album-item">
            <a data-fancybox="gallery" href="https://thiepdientu.com.vn/wp-content/uploads/2024/01/3BC80F6B-B4DE-49FC-8F23-046ADBBC4F05-e1705078098829.jpeg') }}">
                <img src="{{ asset('template06/images/3BC80F6B-B4DE-49FC-8F23-046ADBBC4F05-e1705078098829.jpeg') }}" alt="">
            </a>
        </div>
            </div>
  </section>
          ...
          <div class="invitation">
            <div class="invitation-container">
                ...
                <address class="uk-margin-remove">
                    ...
                    <p class="invi_amlich">Nhằm ngày 24 tháng 12 năm Giáp Thìn</p> 
                </div> 
                ...
                <address class="uk-margin-remove">
                    ...
                    <p class="invi_amlich">Nhằm ngày 25 tháng 12 năm Giáp Thìn</p> 
                </div> 
...
<!-- LỜI CHÚC -->
<!-- TIN NHẮN -->
<section id="message" class="section-message uk-background-cover uk-section" style="background-image:url({{ asset('template06/images/232AA7D4-6D47-4C22-A97B-5BFD8613C2A6-e1705077838673.jpeg') }}); display:block">
	<div class="uk-position-cover uk-overlay uk-overlay-primary" style="opacity:.5"> </div>
      <div class="message-container container uk-position-relative uk-position-z-index">
        ...
        <div class="uk-padding-small uk-border-rounded blur-bg" style="border:1px solid white">
          ...
          <input type="hidden" id="postId" value="1138">
    ...
    <!-- END TIN NHẮN -->
<script>
fetch('/wp-json/wp/v2/comments?post=1138&per_page=100',
    {
     method: 'GET',
    }
    )
  ...
  <div class="container">
    <form action="" method="post" id="form-wedding" style="background-image:url({{ asset('template06/images/paper-cut-sweet-pink-envelope-and-heart-with-copy-space-for-design-valentine-s-day-or-love-day-background-concept-send-a-letter-to-a-lover-couple-free-vector.jpg') }})">
      ...
      <div class="form-container">
          ...
          <label class="radio-container">TƯ GIA NHÀ TRAI            <span class="tooltip"> <p>ẤP H�&nbsp;, XÃ TÂN BÌNH, HUYỆN THANH BÌNH, TỈNH ĐỒNG THÁP</p>
 </span>
...
<section id="gift" class="section-gift" style="display:block">
      <div class="container">
        ...
        <div class="gift-container" id="gift-container">
                                <div class="gift-card">
                    <div class="gift-qr">
                        <img src="{{ asset('template06/images/z5062484714460_86b92a8805a1d69892e3ad506673b204-10-e1705078323591.jpg') }}" alt="" class="groom_qr" style="max-width:100%">
                    </div>
                    <div class="gift-body">
                                        </div>
                </div>
...
<!-- AUDIO -->
<audio src="media/Shane-Filan-Beautiful-In-White-Official-Video-10.mp3" controls="" autoplay="" id="audio">
...
<button class="toggleAudio">
    ...
    <script src="{{ asset('template06/js/fancybox.umd.js') }}" id="fancybox js-js"></script>
<script src="{{ asset('template06/js/uikit.min.js') }}" id="uikit js-js"></script>
<script src="{{ asset('template06/js/uikit-icons.min.js') }}" id="uikit icon-js"></script>
<script src="{{ asset('template06/js/preloader.js') }}" id="preloader js-js"></script>
<script src="{{ asset('template06/js/aos.js') }}" id="aos js-js"></script>
<script src="{{ asset('template06/js/swiper-bundle.min.js') }}" id="swiper slide-js"></script>
<script src="{{ asset('template06/js/scrollreveal.min.js') }}" id="scrollrevea-js"></script>
<script src="{{ asset('template06/js/main-wedding.js') }}" id="main wedding-js"></script>
<script src="{{ asset('template06/js/comment-reply.min.js') }}" id="comment-reply-js" async="" data-wp-strategy="async"></script>
