...
<head>
    ...
    <style>
        ...
        .snowflake {
            ...
            opacity: 0.8;
            top: -10px;
            /* Đặt vị trí bắt đầu phía trên màn hình */
...
<body
    class="mau-thiep-template mau-thiep-template-templates mau-thiep-template-gold mau-thiep-template-templatesgold-php single single-mau-thiep postid-1171 no-sidebar">
    ...
    <script>
        function createSnowflake() {
            ...
            let size = Math.random() * 5 + 3; // Kích thước ngẫu nhiên từ 5px đến 15px
    ...
    <div id="preloader" class="uk-position-fixed uk-background-muted uk-position-z-index"
        ...
        <div class="uk-position-center uk-text-center">
            <img src="{{ asset('template05/images/logo-doc3.png') }}" alt="" style="max-width: 150px;"
    ...
    <section id="banner" class="section-banner">
        <div class="banner-container">
            ...
            <img src="{{ asset('template05/images/bg-top-right.png') }}" alt="" class="bg-top-right"
                data-aos="fade-down-left" data-aos-duration="3000">


            <img src="{{ asset('template05/images/bg-bottom-left.png') }}" alt="" class="bg-bottom-left"
    ...
    <section id="about" class="section-about">
        <div class="section-heading">
            <h2 class="section-title">Chú Rể & Cô Dâu</h2>
        </div>
...
$(document).ready(function(){
  ...
  return false;
    ...
    <script src="{{ asset('template05/js/comment-reply.min.js') }}" id="comment-reply-js" async=""
